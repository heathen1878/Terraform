...
#        (azurecaf_name.network_watcher.result) = {
#            resource_group_name = azurecaf_name.global_resource_group.result
#        }
#    }
#
...
#            resource_group_name = azurecaf_name.demo_resource_group.result
